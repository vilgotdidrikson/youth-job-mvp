...
if (!turn.audioUrl?.startsWith("/api/voice/speech?id=")) throw new Error("Missing cacheable speech URL");
...
sourceNotes = turn.structured.profile.sourceNotes ?? [];
...
console.log(`voice-interview: completed, ${turn.state.askedQuestionIds.length} unique questions${skipOnly ? ", skip-only smoke test" : ", evidence retained, no unsupported German"}`);
